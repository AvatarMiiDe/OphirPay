...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 z-40 flex flex-col">
      {/* Logo */}
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.label}
              {isActive && (
                <span className="ml-auto h-1.5 w-1.5 rounded-full bg-ophir-500" />
              )}
            </Link>
          );
        })}

...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_CONTRACT_ID: z.string().default("CAW7OORNGPRBRQJIXRXZOXEPZZO3Z5FKSCLBULGLBTVVPZYYVTK2UKIA"),
  NEXT_PUBLIC_EMITTER_CONTRACT_ID: z.string().default("CCMXLNRPBTHVTEH7UEBXQVZ4YJZB5NN7LXJBAL465A6YFXJPJGV2CYPX"),
